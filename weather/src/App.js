...
class App extends Component {
  constructor(props) {
    ...
    this.OpenWeatherMapKey = "8833b280a3111148126d98a05d68d03d"
  }
  selectPlace(index) {
    if(index > 0) {
      ...
      <MuiThemeProvider>
        <Card style={{margin: 30}}>
          ...
          <CardText style={{position: 'relative'}}>
            ...
            <WeaterInformation weather={this.state.weather} temperature={this.state.temperature} />
          </CardText>
          <CardActions>
